      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "Why Pursue FA at Riphah International...",
                image: "/books-and-globe.jpg",
              },
              {
                title: "FSc Pre-Engineering at Riphah: Your...",
                image: "/engineering-lab.jpg",
              },
              {
                title: "Empowering Future Professionals with...",
                image: "/business-meeting-collaboration.png",
              },
              {
                title: "ADP in Business Management: Launc...",
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "Riphah International College “ORIENTATION CEREMONY”",
                image: "/image/r17.jpeg",
              },
              {
                title: "🌟“Sports Day & Gala Celebration”",
                image: "/image/r18.jpeg",
              },
              {
                title: "“Celebrating Freedom with Pride”",
                image: "/image/r19.jpeg",
              },
              {
